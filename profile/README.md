...
| --- | --- | --- | --- |
| **3.0** | *TBD* | *Under development* | Python 3.11; Angular 15; PostgreSQL 15, Cypress 12; Merge build templates onto the controller; SQLAlchemy 2; Drop Flask-SQLAlchemy; Replace Moment with date-fns; |
